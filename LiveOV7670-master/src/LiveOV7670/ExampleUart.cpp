...
// 2 - 320x240 with 1M baud - default configuration
// 3 - 160x120 with 1M baud - smaller res, but faster
// 4 - 160x120 with 115200 baud - much slower (for debugging at higher glitch rates)
